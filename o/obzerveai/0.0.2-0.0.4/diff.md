# Comparing `tmp/obzerveai-0.0.2.tar.gz` & `tmp/obzerveai-0.0.4.tar.gz`
...
+gzip compressed data, was "obzerveai-0.0.4.tar", last modified: Sat Apr  6 15:56:22 2024, max compression
```

## Comparing `obzerveai-0.0.2.tar` & `obzerveai-0.0.4.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-06 15:56:22.089894 obzerveai-0.0.4/
+-rw-r--r--   0 runner    (1001) docker     (127)        0 2024-04-06 15:56:18.000000 obzerveai-0.0.4/LICENSE.txt
+-rw-r--r--   0 runner    (1001) docker     (127)     2502 2024-04-06 15:56:22.089894 obzerveai-0.0.4/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)     2056 2024-04-06 15:56:18.000000 obzerveai-0.0.4/README.md
+-rw-r--r--   0 runner    (1001) docker     (127)      620 2024-04-06 15:56:18.000000 obzerveai-0.0.4/pyproject.toml
+-rw-r--r--   0 runner    (1001) docker     (127)       38 2024-04-06 15:56:22.089894 obzerveai-0.0.4/setup.cfg
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-06 15:56:22.085894 obzerveai-0.0.4/src/
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-06 15:56:22.085894 obzerveai-0.0.4/src/obzerveai/
+-rw-r--r--   0 runner    (1001) docker     (127)       32 2024-04-06 15:56:18.000000 obzerveai-0.0.4/src/obzerveai/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)        0 2024-04-06 15:56:18.000000 obzerveai-0.0.4/src/obzerveai/main.py
+-rw-r--r--   0 runner    (1001) docker     (127)     2958 2024-04-06 15:56:18.000000 obzerveai-0.0.4/src/obzerveai/sanitize.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-06 15:56:22.089894 obzerveai-0.0.4/src/obzerveai.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (127)     2502 2024-04-06 15:56:22.000000 obzerveai-0.0.4/src/obzerveai.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)      336 2024-04-06 15:56:22.000000 obzerveai-0.0.4/src/obzerveai.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-06 15:56:22.000000 obzerveai-0.0.4/src/obzerveai.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (127)       24 2024-04-06 15:56:22.000000 obzerveai-0.0.4/src/obzerveai.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (127)       10 2024-04-06 15:56:22.000000 obzerveai-0.0.4/src/obzerveai.egg-info/top_level.txt
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-06 15:56:22.089894 obzerveai-0.0.4/tests/
+-rw-r--r--   0 runner    (1001) docker     (127)      927 2024-04-06 15:56:18.000000 obzerveai-0.0.4/tests/test_main.py
+-rw-r--r--   0 runner    (1001) docker     (127)     3161 2024-04-06 15:56:18.000000 obzerveai-0.0.4/tests/test_sanitize.py
```

### Comparing `obzerveai-0.0.2/pyproject.toml` & `obzerveai-0.0.4/pyproject.toml`
...
### Comparing `obzerveai-0.0.2/src/obzerveai/utils/sanitize.py` & `obzerveai-0.0.4/src/obzerveai/sanitize.py`
...
### Comparing `obzerveai-0.0.2/tests/test_main.py` & `obzerveai-0.0.4/tests/test_main.py`
