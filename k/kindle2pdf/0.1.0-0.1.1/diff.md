# Comparing `tmp/kindle2pdf-0.1.0.tar.gz` & `tmp/kindle2pdf-0.1.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "kindle2pdf-0.1.0.tar", max compression
+gzip compressed data, was "kindle2pdf-0.1.1.tar", max compression
```

## Comparing `kindle2pdf-0.1.0.tar` & `kindle2pdf-0.1.1.tar`

### file list

```diff
@@ -1,4 +1,4 @@
--rw-r--r--   0        0        0      718 2024-04-06 15:42:50.462637 kindle2pdf-0.1.0/README.md
--rw-r--r--   0        0        0    12941 2024-04-06 15:33:40.869888 kindle2pdf-0.1.0/kindle2pdf.py
--rw-r--r--   0        0        0      461 2024-04-06 11:17:52.057444 kindle2pdf-0.1.0/pyproject.toml
--rw-r--r--   0        0        0     1374 1970-01-01 00:00:00.000000 kindle2pdf-0.1.0/PKG-INFO
+-rw-r--r--   0        0        0      718 2024-04-06 15:42:50.462637 kindle2pdf-0.1.1/README.md
+-rw-r--r--   0        0        0    12805 2024-04-06 20:45:09.168777 kindle2pdf-0.1.1/kindle2pdf.py
+-rw-r--r--   0        0        0      461 2024-04-06 20:46:00.810351 kindle2pdf-0.1.1/pyproject.toml
+-rw-r--r--   0        0        0     1374 1970-01-01 00:00:00.000000 kindle2pdf-0.1.1/PKG-INFO
```

### Comparing `kindle2pdf-0.1.0/README.md` & `kindle2pdf-0.1.1/README.md`

 * *Files identical despite different names*

### Comparing `kindle2pdf-0.1.0/kindle2pdf.py` & `kindle2pdf-0.1.1/kindle2pdf.py`
...
+            "dpi": 72,
+            "height": str(int(self.page_size[1] * 72)),
+            "width": str(int(self.page_size[0] * 72)),
             "marginBottom": "0",
             "marginLeft": "9",
             "marginRight": "9",
             "marginTop": "0",
...
### Comparing `kindle2pdf-0.1.0/PKG-INFO` & `kindle2pdf-0.1.1/PKG-INFO`
