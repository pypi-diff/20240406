# Comparing `tmp/protolint_bin_test-0.49.4.post4-py2.py3-none-linux_armv7l.whl.zip` & `tmp/protolint_bin_test-0.49.4.post5-py2.py3-none-win_arm64.whl.zip`
...
## Comparing `protolint_bin_test-0.49.4.post4.dist-info/LICENSE` & `protolint_bin_test-0.49.4.post5.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `protolint_bin_test-0.49.4.post4.dist-info/METADATA` & `protolint_bin_test-0.49.4.post5.dist-info/METADATA`
