# Comparing `tmp/CnbcNews-1.9.tar.gz` & `tmp/CnbcNews-2.0.tar.gz`
...
## Comparing `CnbcNews-1.9.tar` & `CnbcNews-2.0.tar`
...
### Comparing `CnbcNews-1.9/CnbcNews/main.py` & `CnbcNews-2.0/CnbcNews/main.py`
...
### Comparing `CnbcNews-1.9/CnbcNews.egg-info/PKG-INFO` & `CnbcNews-2.0/CnbcNews.egg-info/PKG-INFO`
...
### Comparing `CnbcNews-1.9/PKG-INFO` & `CnbcNews-2.0/PKG-INFO`
...
### Comparing `CnbcNews-1.9/README.md` & `CnbcNews-2.0/README.md`

 * *Files identical despite different names*

### Comparing `CnbcNews-1.9/setup.py` & `CnbcNews-2.0/setup.py`
